...
#TEMPLATE_DIR = r"C:\Users\xchren1\Documents\multi-rel-model\sensitivity"
TEMPLATE_DIR = r"..\\"
OUTPUT_FILE = "casestudy-full-copy.out"
OUTOUT_FILE_LINE = "34: Pcontrol_end_47"
RESULTS_FILE = "results.txt"

PARAM_PREFIX = "return mark(\"PC_sendTO_DataCon_40\") * "
PARAM_SUFFIX = ";"
PARAM_NAME = "3GTranfRate"
...
def execute_sensitivity_analysis():
    ...
    new_value = MIN_VALUE
    values = [0.0005,0.005,0.05,0.25,0.5,1,2.5,5,25,50,100,250,500]
