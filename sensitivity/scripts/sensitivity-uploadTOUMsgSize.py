...
PARAM_PREFIX = "return mark(\"PC_upload_SmartMe_41\") * "
PARAM_SUFFIX = ";"
PARAM_NAME = "uploadTOUMsgSize"
...
def execute_sensitivity_analysis():
    ...
    new_value = MIN_VALUE
    values = [93.75,9.375,0.9375,0.1875,0.09375,0.046875,0.01875,0.009375,0.001875,0.0009375]
